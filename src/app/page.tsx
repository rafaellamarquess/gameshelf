...
export default function HomePage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4  text-white-900 text-center">
      <h1 className="text-4xl md:text-5xl font-bold mb-4">Bem-vindo ao <span className="text-blue-600">GameShelf</span></h1>
      <p className="text-white-600 mb-6 text-lg">Sua coleção de jogos, organizada e acessível</p>
      <Link
        href="/login"
